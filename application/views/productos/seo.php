<div class="content p-0">
    ...
    <div class="content-body">
        <div class="container pd-x-0">
            ...
            <div class="row">
                <div class="col-md-12">
                    <?php $this->load->view("productos/submenu", array("activo" => "seo")); ?>
                </div>
                <div class="col-md-12 mt-2">
                    <div class="card">
                        <div class="card-body">
                            <label class="label font-weight-bold">Slug</label>
                            <input id="slug" type="text" class="form-control input-lg" value="<?php echo $producto->slug; ?>" placeholder="Slug">
							<span><?php echo base_url("/productos/").$producto->slug ?></span>
                        </div>
                    </div>
                    <div class="card mt-2">
                        <div class="card-body">
                            <label class="label font-weight-bold">Metatitle</label>
                            <input id="meta_titulo" type="text" class="form-control input-lg" value="<?php echo $producto->meta_titulo; ?>" placeholder="Metatitle">
                        </div>
                    </div>
                    <div class="card mt-2">
                        <div class="card-body">
                            <label class="label font-weight-bold">Metadescription</label>
							<textarea class="form-control" name="meta_descripcion" id="meta_descripcion"><?php echo $producto->meta_descripcion ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.btn-guardar-seo').on('click', function() {
            ...
            $.ajax({
                url: BASE_URL + 'productos/ajax_modificar_seo',
                method: 'post',
                dataType: 'json',
                data: {
                    id: $id,
