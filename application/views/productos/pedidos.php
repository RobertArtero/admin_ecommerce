		...
		<div class="container pd-x-0">
				...
				<div>
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb breadcrumb-style1 mg-b-10">
							...
							<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url(__class() . "/ver/" . $producto->id); ?>"><?php echo $producto->nombre ?></a></li>
							<li class="breadcrumb-item active" aria-current="page">Pedidos</li>
						</ol>
					</nav>
					<h4 class="mg-b-0 tx-spacing--1">Pedidos de <?php echo $producto->nombre; ?></h4>
				</div>
			...
			<div class="row row-xs">
				...
				<div class="col-md-12 mb-3">
					<?php $this->load->view("productos/submenu",array("activo"=>"pedidos")); ?>
				</div>

				<div class="col-sm-6 col-lg-3 mt-2">
					<div class="card card-body">
						<h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Ventas</h6>
						<div class="d-flex d-lg-block d-xl-flex align-items-end">
							<h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1"><?php echo $ventas;  ?></h3>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-6 col-lg-3 mt-2">
					<div class="card card-body">
						<h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Facturación</h6>
						<div class="d-flex d-lg-block d-xl-flex align-items-end">
							<h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1"><?php echo  __dinero($facturacion); ?></h3>
						</div>
					</div>
				</div>
				...
				<div class="col-md-12 mt-2">
					<div class="card card-body">
						<form method="get" action="<?php base_url("clientes/pedidos") ?>">
							<div class="row">
								...
								<div class="col-md-12 mt-3">
									...
									<a href="<?php echo base_url("productos/pedidos/" . $producto->id); ?>" class="btn btn-transparent border">Quitar filtros</a>
								</div>
							</div>
						</form>
					</div>
							...
							<table class="table table-hover table-bordered">
								...
								<?php  if($pedidos){
									...
									<tr>
										...
										<td class="font-weight-bold py-3"><?php echo __pm($p->nombre_cliente); ?></td>
										<td class="py-3"><?php echo $p->telefono; ?></td>
										<td class="py-3"><?php echo "<i data-feather=\"shopping-bag\"></i> " . $p->total_productos; ?></td>
										<td class="py-3"><?php echo __dinero($p->total_pedido); ?></td>
										<td class="font-weight-bold py-3"><?php echo __arreglo_fecha_completa($p->fecha_entrega); ?></td>
										...
										<td class="p-1"><a href="<?php echo base_url("/pedidos/ver/" . $p->id_pedido); ?>" class="btn btn-transparent border btn-block">Ver</a></td>
									</tr>
								<?php }
								}?>
								</tbody>
