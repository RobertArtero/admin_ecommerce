		...
		<div class="container pd-x-0">
			<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
				<div>
					...
					<h4 class="mg-b-0 tx-spacing--1">Listado de productos</h4>
				</div>
			</div>
			<div class="row row-xs">
				<div class="col-md-12 mb-3">
					<?php $this->load->view("productos/submenu_listado",array("activo"=>"listado")); ?>
				</div>
			</div>
			<div class="row row-xs">
						...
						<form method="get" id="buscador" action="<?php base_url("pedidos/listado") ?>">
							<div class="row">
								...
								<div class="col-md-12 mt-3">
									...
									<a href="<?php echo base_url("productos/listado"); ?>" class="btn btn-transparent border mr-2">Quitar filtros</a>
								...
								<tbody>
									...
									?>
											<tr>
												...
												<td class="py-3"><?php echo ($p->activo) ? "<span class='badge badge-success'>Activo</span>" : "<span class='badge badge-danger'>No activo</span>" ;
													echo ($p->eliminado == 1) ? "<br><span class='badge badge-danger'>Eliminado</span>" :'' ?></td>
