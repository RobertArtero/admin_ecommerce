		...
		<div class="container pd-x-0">
			<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
				<div>
					...
					<h4 class="mg-b-0 tx-spacing--1">Pedidos de <?php echo $cliente->nombre; ?></h4>
				</div>
			...
			<div class="row row-xs">
				...
				<div class="col-md-12 mb-3">
					<?php $this->load->view("clientes/submenu",array("activo"=>"pedidos")); ?>
				</div>
						...
						<form method="get" action="<?php base_url("clientes/pedidos") ?>">
							<div class="row">
								...
								<div class="col-md-12 mt-3">
									...
									<a href="<?php echo base_url("clientes/pedidos/" . $cliente->id); ?>" class="btn btn-transparent border">Quitar filtros</a>
								</div>
							</div>
						</form>
					</div>
							...
							<table class="table table-hover table-bordered">
								...
								<?php  if($pedidos){
									...
									<tr>
										...
										<td class="font-weight-bold py-3"><?php echo __pm($p->nombre); ?></td>
